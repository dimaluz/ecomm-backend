...
class Category(MPTTModel):
    ...
    slug = models.SlugField(
        ...
        help_text=_("format: required, letters, numbers, underscore or hyphens, max-150"),
    )
...
class Brand(models.Model):
    ...
    name = models.CharField(
        ...
        null=False,
        blank=False,
        verbose_name=_("Brand of Product"),
        help_text=_("format: required, unique, max-255"),
    )
...
class ProductInventory(models.Model):
    ...
    sku = models.CharField(
        ...
        help_text=_("format: required, max-20"),
    )
    upc = models.CharField(
        ...
        help_text=_("format: required, max-12"),
    )
    ...
    retail_price = models.DecimalField(
        ...
        help_text=_("format: maximum price 99 999 999.99"),
        validators=[MinValueValidator(Decimal("0.01"))]
        # error_messages={
        #     "name":{
        #         "max_length":_("The price must be between 0.00 and 99 999 999.99"),
        #     },
        # },
    )
...
class Stock(models.Model):
    ...
    class Meta:
        verbose_name = _("Product in Store")
...
class ProductAttributeValues(models.Model):
    ...
    productinventory = models.ForeignKey(
        ProductInventory,
        related_name="productinventoryvalues",
        on_delete=models.PROTECT,
    )
